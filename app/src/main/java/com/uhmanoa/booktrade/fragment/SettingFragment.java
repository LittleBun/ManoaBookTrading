...
import com.uhmanoa.booktrade.utils.CacheUtils;
...
public class SettingFragment extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        switch (v.getId()) {
            case R.id.setting_logout_button:
                if (isLogin()) {
                    ...
                    ToastUtils.showToast(mContext, "Logout", Toast.LENGTH_SHORT);
                    setLogoutUserInfo();
                    skipToLogin();
                }
                break;
            ...
            case R.id.setting_update_layout:
                ToastUtils.showToast(mContext, "No Update", Toast.LENGTH_SHORT);
                break;
        }
    }
    ...
    private void skipToLogin() {
        ToastUtils.showToast(mContext, "Please Login First", Toast.LENGTH_SHORT);
