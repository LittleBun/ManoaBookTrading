...
import com.uhmanoa.booktrade.adapter.CommentAdapter;
    ...
    private void publishComment(User user, String content) {
        ...
        comment.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                // TODO Auto-generated method stub
                ToastUtils.showToast(CommentActivity.this, "Make comment successfully", Toast.LENGTH_SHORT);
...
//						fetchData();
                    ...
                    public void onFailure(int arg0, String arg1) {
                        // TODO Auto-generated method stub
                        LogUtils.i(TAG, "New comment failed" + arg1);
                    }
                });
            ...
            public void onFailure(int arg0, String arg1) {
                // TODO Auto-generated method stub
                ToastUtils.showToast(CommentActivity.this, "New comment failed, check network", Toast.LENGTH_SHORT);
            }
        });
    }
        ...
        if (isLogin() && user != null && user.getSessionToken() != null) {
            ...
            if (!post.getMyFav()) {
                ...
                user.update(this, new UpdateListener() {
                    ...
                    public void onSuccess() {
                        // TODO Auto-generated method stub
                        ToastUtils.showToast(CommentActivity.this, "Save successfully", Toast.LENGTH_SHORT);
...
//						getMyFavourite();
                    ...
                    public void onFailure(int arg0, String arg1) {
                        ...
                        user.setFavorite(favRelation);
                        LogUtils.i(TAG, arg1);
                        ToastUtils.showToast(CommentActivity.this, "Save failed:" + arg0, Toast.LENGTH_SHORT);
                    }
                });
                ...
                user.update(this, new UpdateListener() {
                    ...
                    public void onSuccess() {
                        // TODO Auto-generated method stub
                        ToastUtils.showToast(CommentActivity.this, "Cancel saving successfully", Toast.LENGTH_SHORT);
...
//						getMyFavourite();
                    ...
                    public void onFailure(int arg0, String arg1) {
                        ...
                        user.setFavorite(favRelation);
                        LogUtils.i(TAG, arg1);
                        ToastUtils.showToast(CommentActivity.this, "Cancel saving successfully:" + arg0, Toast.LENGTH_SHORT);
                    }
                });
    ...
    private void onClickLove() {
        if (!isLogin()) {
            ToastUtils.showToast(this, "Please Login First", Toast.LENGTH_SHORT);
    ...
    private void fetchComment() {
        ...
        query.findObjects(this, new FindListener<Comment>() {
            ...
            public void onError(int arg0, String arg1) {
                // TODO Auto-generated method stub
                ToastUtils.showToast(CommentActivity.this, "Fail to update comments, please check network", Toast.LENGTH_SHORT);
                pageNum--;
            }
        });
    }
